...
namespace TravelReview.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReviewID,ReviewTitle,ReviewContent,Stars,CategoryID")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReviewID,ReviewTitle,ReviewContent,Stars,CategoryID")] Review review)
        {
            if (ModelState.IsValid)
            {
